...
namespace Vaquinha.Domain.Entities
{
    public class CreditCard : Entity
    {
        ...
        public CreditCard(string nomeTitular, string numero, string validade, string cvv)
        {
            NomeTitular = nomeTitular;
            NumeroCreditCard = numero;
            Validade = validade;
            CVV = cvv;
        }

        public string NomeTitular { get; private set; }
        public string NumeroCreditCard { get; private set; }
        public string Validade { get; private set; }
        public string CVV { get; private set; }

        public override bool Valido()
        {
            ValidationResult = new CreditCardValidacao().Validate(this);
            return ValidationResult.IsValid;
        }
    }

    public class CreditCardValidacao : AbstractValidator<CreditCard>
    {
        private const int MAX_LENTH_CAMPOS = 150;

        public CreditCardValidacao()
        {
