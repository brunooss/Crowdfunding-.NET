...
namespace Vaquinha.Domain.Entities
{
    public class Address : Entity
    {
        ...
        public Address(Guid id, string cep, string textoAddress, string complemento, string cidade, string estado, string telefone, string numero)
        {
            Id = id;
            CEP = cep;
            TextoAddress = textoAddress;
        ...
        public string TextoAddress { get; private set; }
        ...
        public ICollection<Donation> Doacoes { get; set; }

        public override bool Valido()
        {
            ValidationResult = new AddressValidacao().Validate( this);
            return ValidationResult.IsValid;
        }
    }

    public class AddressValidacao : AbstractValidator<Address>
    {
